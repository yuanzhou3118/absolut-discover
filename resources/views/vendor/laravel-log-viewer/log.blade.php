...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <h1><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>日记列表</h1><a href="{{URL::route('backend.index')}}">返回</a>
...
<script src="{{URL::asset('assets/javascript/jquery-2.1.3.min.js')}}"></script>
